...
replace(prod.modelo, 'Negro', 'Black') AS 'Modelo', vtas.cant, prod.precio,
...
WHERE id IN (
  ...
  /*La subconsulta me devuelve los ID de los clientes que compraron LG*/
  /*Con la consulta general, me vincula esos ID con los datos del cliente*/